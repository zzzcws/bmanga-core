...
[![Alpha release](https://img.shields.io/github/v/release/zzzcws/bmanga-core?include_prereleases&sort=semver&label=alpha)](https://github.com/zzzcws/bmanga-core/releases/tag/v0.1.0-alpha.5)
...
> [!NOTE]
> 当前发布的 `v0.1.0-alpha.5` 镜像提供 English / 简体中文 / 日本語 界面选择。
...
```dotenv
BMANGA_IMAGE=ghcr.io/zzzcws/bmanga-core:0.1.0-alpha.5
...
[发布说明](https://github.com/zzzcws/bmanga-core/releases/tag/v0.1.0-alpha.5)。
...
源码构建需要 Go 1.26.8 或更高版本，以及 Node.js 24 或更高版本。CI 和容器构建目前固定使用
