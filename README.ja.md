...
> [!NOTE]
> 公開中の `v0.1.0-alpha.5` イメージでは、English / 简体中文 / 日本語 の
...
[リリースノート](https://github.com/zzzcws/bmanga-core/releases/tag/v0.1.0-alpha.5)
を確認してください。
...
ソースコードからのビルドには、Go 1.26.8 以降と Node.js 24 以降が必要です。
